...
if sys.version_info < (3, 4, 0):
    sys.stderr.write('FATAL: Hoops needs to be run with Python 3.4+\n')
    sys.exit(1)
...
DESCRIPTION = 'Rapid deployment of lite version of STUPS'
LICENSE = 'Apache License 2.0'
URL = 'https://github.com/korekontrol/hoops'
AUTHOR = 'Marek Obuchowicz'
EMAIL = 'marek@korekontrol.eu'
KEYWORDS = 'aws cloud cf elb ec2 stups route53 boto docker'
...
CONSOLE_SCRIPTS = ['hoops = hoops.cli:main']
